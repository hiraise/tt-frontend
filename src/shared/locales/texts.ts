export const TEXTS = {
  ...
  boards: {
    ...
    empty: "У вас нет ни одной доски, создайте ее прямо сейчас, чтобы начать работу",
  ...
  projects: {
    ...
    kickMemberDescription: "Вы действительно хотите удалить участника {displayName}?",
  },
  tasks: {
